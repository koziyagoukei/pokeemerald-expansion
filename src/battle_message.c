...
static const u8 sText_PkmnSwitchOut[] = _("{B_BUFF1}！ いれかわれ！ もどれ！"); //currently unused, I believe its used for when you switch on a Pokemon in shift mode
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{B_BUFF1}は Lv. {B_BUFF2}に あがった！{WAIT_SE}\p"),
    [STRINGID_PKMNLEARNEDMOVE]                      = COMPOUND_STRING("{B_BUFF1}は {B_BUFF2}を おぼえた！{WAIT_SE}\p"),
    [STRINGID_TRYTOLEARNMOVE1]                      = COMPOUND_STRING("{B_BUFF1}は {B_BUFF2}を おぼえたい。\p"),
    [STRINGID_TRYTOLEARNMOVE2]                      = COMPOUND_STRING("しかし {B_BUFF1}は わざを 4つ おぼえている。\p"),
    [STRINGID_TRYTOLEARNMOVE3]                      = COMPOUND_STRING("{B_BUFF2}を おぼえるために ほかの わざを わすれますか？"),
    [STRINGID_PKMNFORGOTMOVE]                       = COMPOUND_STRING("{B_BUFF1}は {B_BUFF2}を わすれた...\p"),
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}{B_BUFF1}は {B_BUFF2}を おぼえるのを あきらめますか？"),
    [STRINGID_DIDNOTLEARNMOVE]                      = COMPOUND_STRING("{B_BUFF1}は {B_BUFF2}を おぼえなかった。\p"),
    ...
    [STRINGID_ITDOESNTAFFECT]                       = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX2}には こうかが ない みたいだ..."),
    [STRINGID_ITDOESNTAFFECTSCR]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX2}には こうかが ない みたいだ..."),
    [STRINGID_BATTLERFAINTED]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}は たおれた！\p"),
    [STRINGID_PLAYERGOTMONEY]                       = COMPOUND_STRING("しょうきんとして ¥{B_BUFF1} もらった！\p"),
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("たたかえる ポケモンが いなくなった！\p"),
    [STRINGID_PLAYERWHITEOUT2_WILD]                 = COMPOUND_STRING("あわてて ¥{B_BUFF1} おとしてしまった..."),
    [STRINGID_PLAYERWHITEOUT2_TRAINER]              = COMPOUND_STRING("しょうきんとして ¥{B_BUFF1} わたした..."),
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("めのまえが まっくらに なった！"),
    [STRINGID_PREVENTSESCAPE]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_SCR_ABILITY}で にげられない！\p"),
    ...
    [STRINGID_PKMNHPFULL]                           = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}の HPは まんたんだ！"),
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("ひかりのかべで {B_ATK_TEAM2} チームは とくしゅに つよくなった！"),
    [STRINGID_PKMNRAISEDDEF]                        = COMPOUND_STRING("リフレクターで {B_ATK_TEAM2} チームは ぶつりに つよくなった！"),
    [STRINGID_PKMNAURORAVEIL]                       = COMPOUND_STRING("オーロラベールで {B_ATK_TEAM2} チームは つよくなった！"),
    ...
    [STRINGID_PKMNSAPPEDBYLEECHSEED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}は やどりぎに たいりょくを すいとられた！"),
    ...
    [STRINGID_PLAYERPICKEDUPMONEY]                  = COMPOUND_STRING("¥{B_BUFF1} ひろった！\p"),
    ...
    [STRINGID_ANDELLIPSIS]                          = COMPOUND_STRING("そして...\p"),
    ...
    [STRINGID_FAINTINTHREE]                         = COMPOUND_STRING("All Pokemon that heard the song will faint in three turns!"),
    [STRINGID_NOPPLEFT]                             = COMPOUND_STRING("この わざの PPは もうない！\p"), //not in gen 5+
    ...
    [STRINGID_GOTCHAPKMNCAUGHTPLAYER]               = COMPOUND_STRING("やったー！ {B_DEF_NAME}を つかまえたぞ！{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p"),
    ...
    [STRINGID_PKMNDATAADDEDTODEX]                   = COMPOUND_STRING("{B_DEF_NAME}の データが ポケモンずかんに とうろくされた！\p"),
    [STRINGID_ITISRAINING]                          = COMPOUND_STRING("あめが ふっている！"),
    [STRINGID_SANDSTORMISRAGING]                    = COMPOUND_STRING("すなあらしが ふきあれている！"),
    [STRINGID_CANTESCAPE2]                          = COMPOUND_STRING("にげられなかった！\p"),
    ...
    [STRINGID_ENEMYABOUTTOSWITCHPKMN]               = COMPOUND_STRING("{B_TRAINER1_NAME_WITH_CLASS} is about to send out {B_BUFF2}. Will you switch your Pokemon?"),
    ...
    [STRINGID_THREWPOKEBLOCKATPKMN]                 = COMPOUND_STRING("{B_PLAYER_NAME} threw a ポロック at the {B_OPPONENT_MON1_NAME}!"), //safari
    ...
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("Use next Pokemon?"),
