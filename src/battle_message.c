...
const u8 gText_PkmnShroudedInMist[] = _("{JPN}{B_ATK_TEAM1} ポケモンは しろいきりに つつまれた！");
const u8 gText_PkmnGettingPumped[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は きあいを ためている！");
...
static const u8 sText_WildPkmnAppeared[] = _("{JPN}やせいの {B_OPPONENT_MON1_NAME}が あらわれた！\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("{JPN}やせいの {B_OPPONENT_MON1_NAME}が あらわれた！\p");
static const u8 sText_WildPkmnAppearedPause[] = _("{JPN}やせいの {B_OPPONENT_MON1_NAME}が あらわれた！{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("{JPN}やせいの {B_OPPONENT_MON1_NAME}と\n{B_OPPONENT_MON2_NAME}が あらわれた！\p");
static const u8 sText_GhostAppearedCantId[] = _("{JPN}ゆうれいが あらわれた！\pだめだ！\nしょうたいが わからない！\p");
static const u8 sText_TheGhostAppeared[] = _("{JPN}ゆうれいが あらわれた！\p");
static const u8 sText_Trainer1WantsToBattle[] = _("{JPN}{B_TRAINER1_NAME_WITH_CLASS}が しょうぶを しかけてきた！\p");
static const u8 sText_LinkTrainerWantsToBattle[] = _("{JPN}{B_LINK_OPPONENT1_NAME}が しょうぶを しかけてきた！");
...
static const u8 sText_GoTwoPkmn[] = _("{JPN}ゆけっ！ {B_PLAYER_MON1_NAME}！ {B_PLAYER_MON2_NAME}！");
static const u8 sText_GoPkmn2[] = _("{JPN}ゆけっ！ {B_BUFF1}！");
static const u8 sText_DoItPkmn[] = _("{JPN}たのんだぞ！ {B_BUFF1}！");
...
static const u8 sText_YourFoesWeakGetEmPkmn[] = _("{JPN}あいては よわっている！ いけ {B_BUFF1}！");
...
static const u8 sText_PkmnSwitchOut[] = _("{JPN}{B_BUFF1}！ こうたいだ！"); //currently unused, I believe its used for when you switch on a Pokemon in shift mode
static const u8 sText_PkmnThatsEnough[] = _("{JPN}{B_BUFF1}！ よくやった！ もどれ！");
static const u8 sText_PkmnComeBack[] = _("{JPN}{B_BUFF1}！ もどれ！");
static const u8 sText_PkmnOkComeBack[] = _("{JPN}よし {B_BUFF1}！ もどれ！");
static const u8 sText_PkmnGoodComeBack[] = _("{JPN}よくやった {B_BUFF1}！ もどれ！");
...
static const u8 sText_ExclamationMark[] = _("{JPN}！");
static const u8 sText_ExclamationMark2[] = _("{JPN}！");
static const u8 sText_ExclamationMark3[] = _("{JPN}！");
static const u8 sText_ExclamationMark4[] = _("{JPN}！");
...
static const u8 sText_Accuracy[] = _("{JPN}めいちゅう");
static const u8 sText_Evasiveness[] = _("{JPN}かいひ");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGREWTOLV]                         = COMPOUND_STRING("{JPN}{B_BUFF1}は Lv. {B_BUFF2}に あがった！{WAIT_SE}"),
    [STRINGID_PKMNLEARNEDMOVE]                      = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_BUFF2}を おぼえた！{WAIT_SE}"),
    [STRINGID_TRYTOLEARNMOVE1]                      = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_BUFF2}を おぼえたい。"),
    [STRINGID_TRYTOLEARNMOVE2]                      = COMPOUND_STRING("{JPN}しかし {B_BUFF1}は わざを 4つ おぼえている。"),
    [STRINGID_TRYTOLEARNMOVE3]                      = COMPOUND_STRING("{JPN}{B_BUFF2}を おぼえるために\nほかの わざを わすれますか？"),
    [STRINGID_PKMNFORGOTMOVE]                       = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_BUFF2}を わすれた！"),
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{JPN}{PAUSE 32}{B_BUFF1}は {B_BUFF2}を\nおぼえるのを あきらめますか？"),
    [STRINGID_DIDNOTLEARNMOVE]                      = COMPOUND_STRING("{JPN}{B_BUFF1}は {B_BUFF2}をおぼえるのをあきらめた"),
    ...
    [STRINGID_ITDOESNTAFFECT]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}には こうかがないようだ......."),
    [STRINGID_ITDOESNTAFFECTSCR]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX2}には こうかが ない みたいだ..."),
    ...
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("{JPN}{PLAYER}のてもちにはたたかえる ポケモンが いない！"),
    ...
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("{JPN}めのまえが まっくらに なった！"),
    [STRINGID_PREVENTSESCAPE]                       = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の {B_SCR_ABILITY}で にげられない！"),
    [STRINGID_HITXTIMES]                            = COMPOUND_STRING("{JPN}{B_BUFF1}かい あたった！"), //SV has dynamic plural here
    [STRINGID_PKMNFELLASLEEP]                       = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は ねむってしまった！"),
    ...
    [STRINGID_PKMNALREADYASLEEP]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は すでに ねむっている！"),
    ...
    [STRINGID_PKMNALREADYPOISONED]                  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は すでに どくを あびている！"),
    [STRINGID_PKMNBADLYPOISONED]                    = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は もうどくを あびた！"),
    [STRINGID_PKMNENERGYDRAINED]                    = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は たいりょくを すいとられた！"),
    [STRINGID_PKMNWASBURNED]                        = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は やけどを おった！"),
    ...
    [STRINGID_PKMNHURTBYBURN]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は やけどの ダメージを うけている！"),
    [STRINGID_PKMNWASFROZEN]                        = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は こおってしまった！"),
    ...
    [STRINGID_PKMNISFROZEN]                         = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は こおっていて うごけない！"),
    [STRINGID_PKMNWASDEFROSTED]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の こおりが とけた！"),
    [STRINGID_PKMNWASDEFROSTEDBY]                   = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_CURRENT_MOVE}で こおりが とけた！"),
    [STRINGID_PKMNWASPARALYZED]                     = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は しびれて わざが でにくくなった！"),
    ...
    [STRINGID_PKMNISPARALYZED]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は からだが しびれて うごけない！"),
    [STRINGID_PKMNISALREADYPARALYZED]               = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は すでに しびれている！"),
    [STRINGID_PKMNHEALEDPARALYSIS]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の まひが なおった！"),
    [STRINGID_STATSWONTINCREASE]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}は もう あがらない！"),
    [STRINGID_STATSWONTDECREASE]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}は もう さがらない！"),
    [STRINGID_PKMNISCONFUSED]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は こんらんしている！"),
    [STRINGID_PKMNHEALEDCONFUSION]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は こんらんが とけた！"),
    [STRINGID_PKMNWASCONFUSED]                      = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は こんらんした！"),
    [STRINGID_PKMNALREADYCONFUSED]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は すでに こんらんしている！"),
    [STRINGID_PKMNFELLINLOVE]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は メロメロに なった！"),
    [STRINGID_PKMNINLOVE]                           = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_SCR_NAME_WITH_PREFIX2}に メロメロだ！"),
    [STRINGID_PKMNIMMOBILIZEDBYLOVE]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は メロメロで わざが だせない！"),
    [STRINGID_PKMNCHANGEDTYPE]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}タイプに なった！"),
    [STRINGID_PKMNFLINCHED]                         = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は ひるんで わざが だせなかった！"),
    [STRINGID_PKMNREGAINEDHEALTH]                   = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の HPが かいふくした！"),
    [STRINGID_PKMNHPFULL]                           = COMPOUND_STRING("{JPN}しかし{B_DEF_NAME_WITH_PREFIX}の HPは まんたんだ！"),
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("{JPN}ひかりのかべで {B_ATK_TEAM2}\nポケモンは とくしゅに つよくなった！"),
    [STRINGID_PKMNRAISEDDEF]                        = COMPOUND_STRING("{JPN}リフレクターで {B_ATK_TEAM2}\nポケモンは ぶつりに つよくなった！"),
    [STRINGID_PKMNAURORAVEIL]                       = COMPOUND_STRING("{JPN}オーロラベールに {B_ATK_TEAM2} ポケモンはつつまれた！"),
    [STRINGID_PKMNCOVEREDBYVEIL]                    = COMPOUND_STRING("{JPN}{B_ATK_TEAM1}ポケモンは しんぴの ベールに つつまれた！"),
    [STRINGID_PKMNUSEDSAFEGUARD]                    = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}ポケモンは しんぴのまもりに つつまれた！"),
    [STRINGID_PKMNSAFEGUARDEXPIRED]                 = COMPOUND_STRING("{JPN}{B_ATK_TEAM1} ポケモンの しんぴのまもりが きれた！"),
    [STRINGID_PKMNWENTTOSLEEP]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は ねむってしまった！"), //not in gen 5+
    [STRINGID_PKMNSLEPTHEALTHY]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は ねむって HPを かいふくした！"),
    [STRINGID_PKMNWHIPPEDWHIRLWIND]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は かぜを まきおこした！"),
    [STRINGID_PKMNTOOKSUNLIGHT]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は ひかりを すいこんだ！"),
    [STRINGID_PKMNLOWEREDHEAD]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は くびを ひっこめた！"),
    [STRINGID_PKMNFLEWHIGH]                         = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は そらたかく とびあがった！"),
    [STRINGID_PKMNDUGHOLE]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は じめんに もぐった！"),
    [STRINGID_PKMNSQUEEZEDBYBIND]                   = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は {B_SCR_NAME_WITH_PREFIX2}に しめつけられた！"),
    [STRINGID_PKMNTRAPPEDINVORTEX]                  = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は うずの なかに とじこめられた！"),
    [STRINGID_PKMNWRAPPEDBY]                        = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}は {B_SCR_NAME_WITH_PREFIX2}に まきつかれた！"),
    [STRINGID_PKMNCLAMPED]                          = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_EFF_NAME_WITH_PREFIX2}を はさんだ！"),
    [STRINGID_PKMNHURTBY]                           = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}の ダメージを うけた！"),
    [STRINGID_PKMNFREEDFROM]                        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}から かいほうされた！"),
    [STRINGID_PKMNCRASHED]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は いきおいあまって ぶつかった！"),
    [STRINGID_PKMNSHROUDEDINMIST]                   = gText_PkmnShroudedInMist,
    [STRINGID_PKMNPROTECTEDBYMIST]                  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は しろいきりに まもられている！"),
    [STRINGID_PKMNGETTINGPUMPED]                    = gText_PkmnGettingPumped,
    [STRINGID_PKMNHITWITHRECOIL]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は はんどうで ダメージを うけた！"),
    [STRINGID_PKMNPROTECTEDITSELF2]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は まもりの たいせいに はいった！"),
    [STRINGID_PKMNBUFFETEDBYSANDSTORM]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は すなあらしの ダメージを うけている！"),
    [STRINGID_PKMNPELTEDBYHAIL]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は あられの ダメージを うけている！"),
    [STRINGID_PKMNSEEDED]                           = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}に たねを うえつけた！"),
    [STRINGID_PKMNAVOIDEDATTACK]                    = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は こうげきを かわした！"),
    [STRINGID_BATTLERAVOIDEDATTACK]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は こうげきを かわした！"),
    [STRINGID_PKMNSAPPEDBYLEECHSEED]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は やどりぎに\nたいりょくを すいとられている。"),
    [STRINGID_PKMNFASTASLEEP]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は ぐうぐう ねむっている。"),
    [STRINGID_PKMNWOKEUP]                           = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は めを さました！"),
    [STRINGID_PKMNWOKEUPINUPROAR]                   = COMPOUND_STRING("{JPN} {B_EFF_NAME_WITH_PREFIX2}はうるさくてめがさめた！"),
    [STRINGID_PKMNCAUSEDUPROAR]                     = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX} はさわぎはじめた！"),
    [STRINGID_PKMNMAKINGUPROAR]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はさわいでいる！"),
    [STRINGID_PKMNCALMEDDOWN]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はさわぐのをやめた。"),
    [STRINGID_PKMNSTOCKPILED]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} は {B_BUFF1}つたくわえた！"),
    [STRINGID_PKMNCANTSLEEPINUPROAR2]               = COMPOUND_STRING("{JPN}しかし {B_DEF_NAME_WITH_PREFIX2} はさわいでいてねむらない！"),
    [STRINGID_UPROARKEPTPKMNAWAKE]                  = COMPOUND_STRING("{JPN}うるさくて{B_DEF_NAME_WITH_PREFIX2}はめをさました！"),
    [STRINGID_PKMNSTAYEDAWAKEUSING]                 = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} はねむらない！"),
    [STRINGID_PKMNSTORINGENERGY]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はちからをためている！"),
    [STRINGID_PKMNUNLEASHEDENERGY]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はためたちからをときはなった！"),
    [STRINGID_PKMNFATIGUECONFUSION]                 = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}はつかれはててこんらんした！"),
    [STRINGID_PLAYERPICKEDUPMONEY]                  = COMPOUND_STRING("{JPN}{B_BUFF1}円 ひろった！"),
    [STRINGID_PKMNUNAFFECTED]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}にこうかはない！"),
    [STRINGID_PKMNTRANSFORMEDINTO]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} は {B_BUFF1}にフォルムチェンジした！"),
    [STRINGID_PKMNMADESUBSTITUTE]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はみがわりをおいた！"),
    [STRINGID_PKMNHASSUBSTITUTE]                    = COMPOUND_STRING("{JPN}しかしすでにみがわりはでている！"),
    [STRINGID_SUBSTITUTEDAMAGED]                    = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX2}のみがわりがかわりにダメージをうけた！"),
    [STRINGID_PKMNSUBSTITUTEFADED]                  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}のみがわりはきえてしまった……"),
    [STRINGID_PKMNMUSTRECHARGE]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}ははんどうでうごけない！"),
    [STRINGID_PKMNRAGEBUILDING]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}のいかりのボルテージがあがった！"),
    [STRINGID_PKMNMOVEWASDISABLED]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}の {B_BUFF1}をかなしばりにした！"),
    [STRINGID_PKMNMOVEISDISABLED]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}の{B_CURRENT_MOVE}\nはかなしばりでつかえない！"),
    [STRINGID_PKMNMOVEDISABLEDNOMORE]               = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}のかなしばりがとけた！"),
    [STRINGID_PKMNGOTENCORE]                        = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} はアンコールした！"),
    [STRINGID_PKMNGOTENCOREDMOVE]                   = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_CURRENT_MOVE}しかつかえない！"),
    [STRINGID_PKMNENCOREENDED]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX} のアンコールがとけた！"),
    [STRINGID_PKMNTOOKAIM]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} は{B_DEF_NAME_WITH_PREFIX2}にねらいをさだめた！"),
    [STRINGID_PKMNSKETCHEDMOVE]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} は {B_BUFF1}をスケッチした！"),
    [STRINGID_PKMNTRYINGTOTAKEFOE]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はみちづれにしようとしている！"),
    [STRINGID_PKMNTOOKFOE]                          = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はあいてをみちづれにした！"),
    [STRINGID_PKMNREDUCEDPP]                        = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} の {B_BUFF1}の\nPPが{B_BUFF2}さがった！"),
    [STRINGID_PKMNSTOLEITEM]                        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} は {B_EFF_NAME_WITH_PREFIX2}の\n{B_LAST_ITEM}をうばった！"),
    [STRINGID_TARGETCANTESCAPENOW]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} はにげられない！"),
    [STRINGID_PKMNFELLINTONIGHTMARE]                = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はあくむをみはじめた！"),
    [STRINGID_PKMNLOCKEDINNIGHTMARE]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はあくむをみている！"),
    [STRINGID_PKMNLAIDCURSE]                        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はじぶんのみをけずり\n{B_DEF_NAME_WITH_PREFIX2}をのろった！"),
    [STRINGID_PKMNAFFLICTEDBYCURSE]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はのろわれている！"),
    [STRINGID_SPIKESSCATTERED]                      = COMPOUND_STRING("{JPN}まきびし が　{B_DEF_TEAM2}ばに ちらばった！"),
    [STRINGID_PKMNHURTBYSPIKES]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}はまきびしをふんでいたい！"),
    [STRINGID_PKMNIDENTIFIED]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はみやぶられた！"),
    [STRINGID_PKMNPERISHCOUNTFELL]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}のほろびのカウントが\n{B_BUFF1}になった！"),
    [STRINGID_PKMNBRACEDITSELF]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はこらえている！"),
    [STRINGID_PKMNENDUREDHIT]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はこうげきをこらえた！"),
    [STRINGID_MAGNITUDESTRENGTH]                    = COMPOUND_STRING("{JPN}マグニチュード{B_BUFF1}！"),
    [STRINGID_PKMNCUTHPMAXEDATTACK]                 = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はみをけずってパワーぜんかい！"),
    [STRINGID_PKMNCOPIEDSTATCHANGES]                = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は あいてののうりょくへんかをコピーした！"),
    [STRINGID_PKMNGOTFREE]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} は {B_BUFF1}からかいほうされた！"),
    [STRINGID_PKMNSHEDLEECHSEED]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はやどりぎのタネからかいほうされた！"),
    [STRINGID_PKMNBLEWAWAYSPIKES]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はまきびしをふきとばした！"), // Not in gen 5+
    [STRINGID_PKMNFLEDFROMBATTLE]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はにげた！"),
    [STRINGID_PKMNFORESAWATTACK]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はみらいにこうげきをよちした！"),
    [STRINGID_PKMNTOOKATTACK]                       = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} は {B_BUFF1} のこうげきをうけた！"),
    [STRINGID_PKMNATTACK]                           = COMPOUND_STRING("{JPN}{B_BUFF1}のこうげき！"), // Not in gen 5+
    [STRINGID_PKMNCENTERATTENTION]                  = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はちゅうもくのまととなった！"),
    [STRINGID_PKMNCHARGINGPOWER]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はちからをためている！"),
    [STRINGID_NATUREPOWERTURNEDINTO]                = COMPOUND_STRING("{JPN}しぜんのちからは{B_CURRENT_MOVE}にへんかした！"),
    [STRINGID_PKMNSTATUSNORMAL]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}のじょうたいがもどった！"),
    [STRINGID_PKMNHASNOMOVESLEFT]                   = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はつかえるわざがない！"),
    [STRINGID_PKMNSUBJECTEDTOTORMENT]               = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はいちゃもんをつえられた！"),
    [STRINGID_PKMNCANTUSEMOVETORMENT]               = COMPOUND_STRING("{JPN}いちゃもんのせいでおなじわざはつづけてだせない！"),
    [STRINGID_PKMNTIGHTENINGFOCUS]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はこころのめでねらいをさだめた！"),
    [STRINGID_PKMNFELLFORTAUNT]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はちょうはつにのってしまった！"),
    [STRINGID_PKMNCANTUSEMOVETAUNT]                 = COMPOUND_STRING("{JPN}ちょうはつされていて {B_CURRENT_MOVE}をだせない！"),
    [STRINGID_PKMNREADYTOHELP]                      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_DEF_NAME_WITH_PREFIX2}をてだすけした！"),
    [STRINGID_PKMNSWITCHEDITEMS]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はおたがいのアイテムをいれかえた！"),
    [STRINGID_PKMNCOPIEDFOE]                        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_DEF_NAME_WITH_PREFIX2}のとくせいをコピーした！"),
    [STRINGID_PKMNWISHCAMETRUE]                     = COMPOUND_STRING("{JPN}ねがいごとがかなった！"),
    [STRINGID_PKMNPLANTEDROOTS]                     = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}のねをはる！"),
    [STRINGID_PKMNABSORBEDNUTRIENTS]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}はねっこからえいようをすいとった！"),
    ...
    [STRINGID_ANDELLIPSIS]                          = COMPOUND_STRING("{JPN}そして……!"),
    ...
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("{JPN}オダマキ『み みすてないでくれー!』"), //no decapitalize until it is everywhere
    ...
    [STRINGID_NOPPLEFT]                             = COMPOUND_STRING("{JPN}わざの のこりポイントが ない!\"), //not in gen 5+
    ...
    [STRINGID_CANTESCAPE2]                          = COMPOUND_STRING("{JPN}にげられない！"),
    ...
    [STRINGID_PKMNSXTOOKATTACK]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} はこうげきをうけた！"),
    [STRINGID_PKMNCHOSEXASDESTINY]                  = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}ははめつのねがいをねがった！"),
    [STRINGID_PKMNLOSTFOCUS]                        = COMPOUND_STRING("{JPN}しゅうちゅうりょくが\nとぎれて わざが だせなかった!"),
    [STRINGID_USENEXTPKMN]                          = COMPOUND_STRING("{JPN}つぎの ポケモンを つかいますか?"),
    [STRINGID_PKMNFLEDUSINGITS]                     = COMPOUND_STRING("{JPN}{PLAY_SE SE_FLEE}{B_ATK_NAME_WITH_PREFIX}は\n{B_LAST_ITEM}を つかって にげた"),
    [STRINGID_PKMNFLEDUSING]                        = COMPOUND_STRING("{JPN}{PLAY_SE SE_FLEE}{B_ATK_ABILITY}を つかって にげた"), //not in gen 5+
    ...
    [STRINGID_TURBOBLAZEENTERS]                     = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は もえる オーラを\nはなっている！"),
    ...
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は すべての オーラを はんてんさせた！"),
    [STRINGID_COMATOSEENTERS]                       = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は ねむたそうだ！"),
    ...
    [STRINGID_NEUTRALIZINGGASENTERS]                = COMPOUND_STRING("{JPN}かがくへんかガスが あたりに たちこめた！"),
    ...
    [STRINGID_BEINGHITCHARGEDPKMNWITHPOWER]         = COMPOUND_STRING("{JPN}{B_CURRENT_MOVE}を うけて\n{B_EFF_NAME_WITH_PREFIX2}は パワーを ためこんだ！"),
    ...
    [STRINGID_ATTACKERGAINEDSTRENGTHFROMTHEFALLEN]  = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は たおれたものから\nちからを えた！"),
    ...
    [STRINGID_PKMNMADESHELLGLEAM]                   = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は\nこうらを かがやかせた！ タイプあいしょうが ゆがむ！"),
    [STRINGID_FICKLEBEAMDOUBLED]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\nこの こうげきに ぜんりょくを そそいだ！"),
    [STRINGID_COMMANDERACTIVATES]                   = COMPOUND_STRING("{JPN}{B_SCR_NAME_WITH_PREFIX}は {B_BUFF1}に のみこまれ\n{B_BUFF1}の しれいとうに なった！"),
    [STRINGID_POKEFLUTECATCHY]                      = COMPOUND_STRING("{JPN}{B_PLAYER_NAME}は {B_LAST_ITEM}！\pうーん！\nすばらしい ねいろだ！"),
    ...
    [STRINGID_BLOCKEDBYSLEEPCLAUSE]                 = COMPOUND_STRING("{JPN}スリープクローズにより\n{B_DEF_NAME_WITH_PREFIX2}は ねむらない！"),
...
static const u8 sText_Trainer2SentOutPkmn[] = _("{JPN}{B_TRAINER2_NAME_WITH_CLASS}は {B_BUFF1}を くりだした！");
