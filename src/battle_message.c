...
const u8 gText_PkmnShroudedInMist[] = _("{B_ATK_TEAM1} チームは しろいきりに つつまれた！");
...
static const u8 sText_TwoWildPkmnAppeared[] = _("やせいの {B_OPPONENT_MON1_NAME}と {B_OPPONENT_MON2_NAME}が あらわれた！\p");
...
static const u8 sText_TwoLinkTrainersWantToBattle[] = _("{B_LINK_OPPONENT1_NAME}と {B_LINK_OPPONENT2_NAME}が しょうぶを しかけてきた！");
static const u8 sText_Trainer1SentOutPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS}は {B_OPPONENT_MON1_NAME}を くりだした！");
static const u8 sText_Trainer1SentOutTwoPkmn[] = _("{B_TRAINER1_NAME_WITH_CLASS}は {B_OPPONENT_MON1_NAME}と {B_OPPONENT_MON2_NAME}を くりだした！");
...
static const u8 sText_LinkTrainerSentOutTwoPkmn[] = _("{B_LINK_OPPONENT1_NAME}は {B_OPPONENT_MON1_NAME}と {B_OPPONENT_MON2_NAME}を くりだした！");
static const u8 sText_TwoLinkTrainersIntroSendOutPkmn[] = _("{B_LINK_OPPONENT1_NAME}は {B_LINK_OPPONENT_MON1_NAME}を くりだした！ {B_LINK_OPPONENT2_NAME}は {B_LINK_OPPONENT_MON2_NAME}を くりだした！");
...
static const u8 sText_LinkPartnerSentOutPkmn1GoPkmn[] = _("{B_LINK_PARTNER_NAME}は {B_LINK_PLAYER_MON1_NAME}を くりだした！ ゆけっ！ {B_LINK_PLAYER_MON2_NAME}！");
static const u8 sText_LinkPartnerSentOutPkmn2GoPkmn[] = _("{B_LINK_PARTNER_NAME}は {B_LINK_PLAYER_MON2_NAME}を くりだした！ ゆけっ！ {B_LINK_PLAYER_MON1_NAME}！");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXP]                        = COMPOUND_STRING("{B_BUFF1}は{B_BUFF2} {B_BUFF3}の けいけんちを もらった！\p"),
    ...
    [STRINGID_TRYTOLEARNMOVE3]                      = COMPOUND_STRING("{B_BUFF2}を おぼえるために ほかの わざを わすれますか？"),
    [STRINGID_PKMNFORGOTMOVE]                       = COMPOUND_STRING("{B_BUFF1}は {B_BUFF2}を わすれた！"),
    [STRINGID_STOPLEARNINGMOVE]                     = COMPOUND_STRING("{PAUSE 32}{B_BUFF1}は {B_BUFF2}を おぼえるのを あきらめますか？"),
    ...
    [STRINGID_PKMNMADESLEEP]                        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}で {B_EFF_NAME_WITH_PREFIX2}は ねむってしまった！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNPOISONEDBY]                       = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}で {B_EFF_NAME_WITH_PREFIX2}は どくを あびた！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNBURNEDBY]                         = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}で {B_EFF_NAME_WITH_PREFIX2}は やけどを おった！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNFROZENBY]                         = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}で {B_EFF_NAME_WITH_PREFIX2}は こおってしまった！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNWASPARALYZEDBY]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}で {B_EFF_NAME_WITH_PREFIX2}は しびれてしまった！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("ひかりのかべで {B_ATK_TEAM2} たちは とくしゅに つよくなった！"),
    [STRINGID_PKMNRAISEDDEF]                        = COMPOUND_STRING("リフレクターで {B_ATK_TEAM2} たちは ぶつりに つよくなった！"),
    [STRINGID_PKMNAURORAVEIL]                       = COMPOUND_STRING("オーロラベールに {B_ATK_TEAM2} たちはつつまれた！"),
    [STRINGID_PKMNCOVEREDBYVEIL]                    = COMPOUND_STRING("{B_ATK_TEAM1} チームは しんぴの ベールに つつまれた！"),
    [STRINGID_PKMNUSEDSAFEGUARD]                    = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}は しんぴのまもりに つつまれた！"),
    [STRINGID_PKMNSAFEGUARDEXPIRED]                 = COMPOUND_STRING("{B_ATK_TEAM1} チームの しんぴのまもりが きれた！"),
    ...
    [STRINGID_PKMNSAPPEDBYLEECHSEED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}は やどりぎに たいりょくを すいとられている。"),
    ...
    [STRINGID_PKMNMOVEISDISABLED]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}の{B_CURRENT_MOVE} はかなしばりでつかえない！"),
    ...
    [STRINGID_PKMNREDUCEDPP]                        = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} の {B_BUFF1}の PPが{B_BUFF2}さがった！"),
    [STRINGID_PKMNSTOLEITEM]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} は {B_EFF_NAME_WITH_PREFIX2}の {B_LAST_ITEM}をうばった！"),
    ...
    [STRINGID_PKMNLAIDCURSE]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}はじぶんのみをけずり {B_DEF_NAME_WITH_PREFIX2}をのろった！"),
    [STRINGID_PKMNAFFLICTEDBYCURSE]                 = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}はのろわれている！"),
    [STRINGID_SPIKESSCATTERED]                      = COMPOUND_STRING("まきびしが{B_DEF_TEAM2}のばにちらばった！"),
    ...
    [STRINGID_PKMNPERISHCOUNTFELL]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}のほろびのカウントが {B_BUFF1}になった！"),
    ...
    [STRINGID_PKMNCANTUSEMOVESEALED]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}はふういんされていて {B_CURRENT_MOVE}をだせない！"),
    ...
    [STRINGID_PKMNPREVENTSUSAGE]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}の {B_DEF_ABILITY}で  {B_CURRENT_MOVE}がつかえない！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNDATAADDEDTODEX]                   = COMPOUND_STRING("{B_DEF_NAME}の データが ポケモンずかんに とうろくされた！"),
    ...
    [STRINGID_PKMNSITEMCUREDPROBLEM]                = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の{B_LAST_ITEM} で{B_BUFF1}がなおった！"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSXMADEYUSELESS]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_SCR_ABILITY}で {B_CURRENT_MOVE}はきかない！"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSITEMNORMALIZEDSTATUS]            = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}は {B_LAST_ITEM} でじょうたいいじょうがなおった！"), // Not in Gen 5+
    ...
    [STRINGID_PKMNSXBLOCKSY]                        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_SCR_ABILITY}で {B_CURRENT_MOVE}をふせいだ！"), //not in gen 5+, ability popup
    ...
    [STRINGID_TIEDOPPONENTBYREFEREE]                = COMPOUND_STRING("はんていにより{B_PLAYER_MON1_NAME}は {B_OPPONENT_MON1_NAME}とひきわけた！"),
    ...
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("It created a bizarre area in which Pokemon's held items lose their effects!"),
    ...
    [STRINGID_STATWASMAXEDOUT]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}の {B_BUFF1}が さいだいまで あがった！"),
    ...
    [STRINGID_MEGAEVOREACTING]                      = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}の {B_LAST_ITEM}が {B_ATK_TRAINER_NAME}の メガリングに はんのうした！"), //actually displays the type of mega ring in inventory, but we didnt implement them :(
    ...
    [STRINGID_POWDEREXPLODES]                       = COMPOUND_STRING("When the flame touched the powder on the Pokemon, it exploded!"),
    ...
    [STRINGID_AURABREAKENTERS]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} reversed all other Pokemon's auras!"),
    ...
    [STRINGID_MYSTERIOUSAIRCURRENT]                 = COMPOUND_STRING("Mysterious strong winds are protecting Flying-type Pokemon!"),
    ...
    [STRINGID_ZMOVERESETSSTATS]                     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}は Zパワーで さがった のうりょくを もどした！"),
    [STRINGID_ZMOVEALLSTATSUP]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}は Zパワーで のうりょくが あがった！"),
    [STRINGID_ZMOVEZBOOSTCRIT]                      = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}は Zパワーで きゅうしょに あたりやすくなった！"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} weakened the {B_BUFF1} of all surrounding Pokemon!\p"),
    ...
    [STRINGID_ULTRABURSTCOMPLETED]                  = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}は ウルトラバーストで ほんとうの ちからを とりもどした！"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("Sharp-pointed pieces of steel started floating around {B_DEF_TEAM2} Pokemon!"),
    ...
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("The pieces of steel surrounding {B_ATK_TEAM2} Pokemon disappeared!"),
    ...
    [STRINGID_TEAMCAUGHTINVORTEX]                   = COMPOUND_STRING("{B_EFF_TEAM1} Pokemon got caught in a vortex of water!"),
    ...
    [STRINGID_TEAMSURROUNDEDBYROCKS]                = COMPOUND_STRING("{B_EFF_TEAM1} Pokemon became surrounded by rocks!"),
    ...
    [STRINGID_BIZARREARENACREATED]                  = COMPOUND_STRING("A bizarre area was created in which Pokemon's held items lose their effects!"),
    ...
    [STRINGID_NOTVERYEFFECTIVETWOFOES]              = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX2}と {B_DEF_PARTNER_NAME}には こうかは いまひとつだ..."),
...
const u8 *const gRefereeStringsTable[] =
{
    ...
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("REFEREE: Judging category 1, Mind! The POKEMON showing the most guts!\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("REFEREE: Judging category 2, Skill! The POKEMON using moves the best!\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("REFEREE: Judging category 3, Body! The POKEMON with the most vitality!\p"),
