...
static const u8 sText_TwoWildPkmnAppeared[] = _("{JPN}あ！  やせいの\n{B_OPPONENT_MON1_NAME}と {B_OPPONENT_MON2_NAME}がとびだしてきた!\p");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("{JPN}オダマキみ みすてないでくれー!\p"), //no decapitalize until it is everywhere
    ...
    [STRINGID_OUTOFSAFARIBALLS]                     = COMPOUND_STRING("{JPN}{PLAY_SE SE_DING_DONG}アナウンスピンポーン! サファリボールが\nなくなったので しゅうりょうでーす!\p"), //safari
    ...
    [STRINGID_POISONSPIKESSCATTERED]                = COMPOUND_STRING("{JPN}どくびしが {B_DEF_TEAM2} ばにちらばった！"),
    [STRINGID_PKMNSWITCHEDSTATCHANGES]              = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はあいてと\nのうりょくへんかをいれかえた！"),
    [STRINGID_PKMNSURROUNDEDWITHVEILOFWATER]        = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はみずのベールをまとった！"),
    [STRINGID_PKMNLEVITATEDONELECTROMAGNETISM]      = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はでんじふゆうでういた！"),
    [STRINGID_PKMNTWISTEDDIMENSIONS]                = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はじくうをゆがめた！"),
    [STRINGID_POINTEDSTONESFLOAT]                   = COMPOUND_STRING("{JPN}{B_DEF_TEAM2} ばにいわがただよった！"),
    [STRINGID_TRAPPEDBYSWIRLINGMAGMA]               = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX} はマグマのうずにとじこめられた！"),
    [STRINGID_VANISHEDINSTANTLY]                    = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はいっしゅんできえた！"),
    [STRINGID_PROTECTEDTEAM]                        = COMPOUND_STRING("{JPN}{B_CURRENT_MOVE} で {B_ATK_TEAM2}\nポケモンはまもられた！"),
    [STRINGID_SHAREDITSGUARD]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はあいてとまもりをわけあった！"),
    [STRINGID_SHAREDITSPOWER]                       = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はあいてとちからをわけあった！"),
    [STRINGID_SWAPSDEFANDSPDEFOFALLPOKEMON]         = COMPOUND_STRING("{JPN}ふしぎなくうかんがあたりをつつみこんだ！"),
    [STRINGID_BECAMENIMBLE]                         = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX} はみがるになった！"),
    [STRINGID_HURLEDINTOTHEAIR]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} はそらたかくつれさられた！"),
    [STRINGID_HELDITEMSLOSEEFFECTS]                 = COMPOUND_STRING("{JPN}ふしぎなくうかんでもちもののこうかがきえた！"),
    [STRINGID_FELLSTRAIGHTDOWN]                     = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}はじめんにおちた！"),
    [STRINGID_TARGETCHANGEDTYPE]                    = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_BUFF1}タイプに なった！"),
    [STRINGID_KINDOFFER]                            = COMPOUND_STRING("{JPN}{B_DEF_NAME_WITH_PREFIX} はそのとおりにした！"),
    [STRINGID_RESETSTARGETSSTATLEVELS]              = COMPOUND_STRING("{JPN}{B_EFF_NAME_WITH_PREFIX}のステータスへんかがなくなった！"),
    ...
    [STRINGID_EMBARGOENDS]                          = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX} はまたどうぐがつかえる！"),
    ...
    [STRINGID_TAILWINDENDS]                         = COMPOUND_STRING("{JPN}{B_ATK_TEAM1} ポケモンのおいかぜがやんだ！"),
    [STRINGID_LUCKYCHANTENDS]                       = COMPOUND_STRING("{JPN}{B_ATK_TEAM1} ポケモンのおまじないがきえた！"),
    ...
    [STRINGID_STICKYWEBUSED]                        = COMPOUND_STRING("{JPN}ねばねばネットが {B_DEF_TEAM2} ばにはられた！"),
    ...
    [STRINGID_SPIKESDISAPPEAREDFROMTEAM]            = COMPOUND_STRING("{JPN} {B_ATK_TEAM2} ばのまきびしがきえた！"),
    [STRINGID_TOXICSPIKESDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("{JPN} {B_ATK_TEAM2} ばのどくびしがきえた！"),
    [STRINGID_STICKYWEBDISAPPEAREDFROMTEAM]         = COMPOUND_STRING("{JPN} {B_ATK_TEAM2} ばのねばねばネットがきえた！"),
    [STRINGID_STEALTHROCKDISAPPEAREDFROMTEAM]       = COMPOUND_STRING("{JPN}{B_ATK_TEAM2} ばのいわがきえた！"),
    ...
    [STRINGID_SHARPSTEELFLOATS]                     = COMPOUND_STRING("{JPN}とがったいわが {B_DEF_TEAM2} ポケモンにささる！"),
    ...
    [STRINGID_SHARPSTEELDISAPPEAREDFROMTEAM]        = COMPOUND_STRING("{JPN}{B_ATK_TEAM2} ばのとがったはがねがきえた！"),
    ...
    [STRINGID_ARAINBOWAPPEAREDONSIDE]               = COMPOUND_STRING("{JPN}{B_ATK_TEAM2} ばのそらににじがあらわれた！"),
    [STRINGID_THERAINBOWDISAPPEARED]                = COMPOUND_STRING("{JPN}{B_ATK_TEAM2} ばのにじがきえた！"),
    [STRINGID_WAITINGFORPARTNERSMOVE]               = COMPOUND_STRING("{JPN}{B_ATK_NAME_WITH_PREFIX}は\n{B_ATK_PARTNER_NAME}の わざを まっている...{PAUSE 16}"),
    [STRINGID_SEAOFFIREENVELOPEDSIDE]               = COMPOUND_STRING("{JPN}ほのおのうみで {B_DEF_TEAM2} ばはつつまれた！"),
    ...
    [STRINGID_GHOSTGETOUTGETOUT]                    = COMPOUND_STRING("{JPN}ゆうれいタチサレ…… タチサレ……"),
    ...
    [STRINGID_REFLECTWOREOFF]                       = COMPOUND_STRING("{JPN}{B_DEF_TEAM1} リフレクターがきえた！"),
    [STRINGID_LIGHTSCREENWOREOFF]                   = COMPOUND_STRING("{JPN}{B_DEF_TEAM1} ひかりのかべがきえた！"),
    [STRINGID_AURORAVEILWOREOFF]                    = COMPOUND_STRING("{JPN}{B_DEF_TEAM1} オーロラベールがきえた！"),
...
{
    [B_MSG_REF_NOTHING_IS_DECIDED] = COMPOUND_STRING("{JPN}しんぱんあと 3ターンで けっちゃくが\nつかないと はんていに なります!"),
    [B_MSG_REF_THATS_IT]           = COMPOUND_STRING("{JPN}しんぱんそこまでーーー!\nこの たいけつは はんていに なります!"),
    [B_MSG_REF_JUDGE_MIND]         = COMPOUND_STRING("{JPN}しんぱんはんてい その1! こころ!\nせめる きもちを みせたもの!\p"),
    [B_MSG_REF_JUDGE_SKILL]        = COMPOUND_STRING("{JPN}しんぱんはんてい その2! わざ!\nてきかくに わざを くりだしたもの!\p"),
    [B_MSG_REF_JUDGE_BODY]         = COMPOUND_STRING("{JPN}しんぱんはんてい その3! からだ!\nあふれる たいりょくを もちえるもの!\p"),
    [B_MSG_REF_PLAYER_WON]         = COMPOUND_STRING("{JPN}しんぱんはんてい {B_BUFF1} たい {B_BUFF2}\nしょうしゃ！ {B_PLAYER_NAME}の  {B_PLAYER_MON1_NAME}！\p"),
    [B_MSG_REF_OPPONENT_WON]       = COMPOUND_STRING("{JPN}しんぱんはんてい {B_BUFF1} たい {B_BUFF2}\nしょうしゃ！ {B_TRAINER1_NAME}の  {B_OPPONENT_MON1_NAME}！\p"),
    [B_MSG_REF_DRAW]               = COMPOUND_STRING("{JPN}しんぱんはんてい 3 たい 3\nひきわけーーー!\p"),
