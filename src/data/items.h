...
// GEN 9 ITEMS
    ...
    {
        .name = ITEM_NAME("にばいづけだいこん"),
        .pluralName = ITEM_PLURAL_NAME("にばいづけだいこん"),
        .price = 1600,
        .description = sQuestionMarksDesc,
        .pocket = POCKET_ITEMS,
        .sortType = ITEM_TYPE_AUX_ITEM,
