...
static const u8 *const sHelpBarTexts[HELPBAR_COUNT] =
{
    ...
    [HELPBAR_MAP_ZOOMED_OUT]        = COMPOUND_STRING("{A_BUTTON}ズーム {B_BUTTON}やめる"),
    [HELPBAR_MAP_ZOOMED_IN]         = COMPOUND_STRING("{A_BUTTON}ぜんたい {B_BUTTON}やめる"),
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}ズーム {B_BUTTON}やめる {R_BUTTON}そら"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}ぜんたい {B_BUTTON}やめる {R_BUTTON}そら"),
    [HELPBAR_CONDITION_MON_LIST]    = COMPOUND_STRING("{A_BUTTON}コンディション {B_BUTTON}やめる"),
    [HELPBAR_CONDITION_MON_STATUS]  = COMPOUND_STRING("{A_BUTTON}マーク {B_BUTTON}やめる"),
    [HELPBAR_CONDITION_MARKINGS]    = COMPOUND_STRING("{A_BUTTON}マークえらぶ {B_BUTTON}やめる"),
    [HELPBAR_MC_TRAINER_LIST]       = COMPOUND_STRING("{A_BUTTON}メニュー {B_BUTTON}やめる"),
    [HELPBAR_MC_CALL_MENU]          = COMPOUND_STRING("{A_BUTTON}OK {B_BUTTON}やめる"),
    [HELPBAR_MC_CHECK_PAGE]         = COMPOUND_STRING("{B_BUTTON}やめる"),
    [HELPBAR_RIBBONS_MON_LIST]      = COMPOUND_STRING("{A_BUTTON}リボン {B_BUTTON}やめる"),
    [HELPBAR_RIBBONS_LIST]          = COMPOUND_STRING("{A_BUTTON}みる {B_BUTTON}やめる"),
    [HELPBAR_RIBBONS_CHECK]         = COMPOUND_STRING("{B_BUTTON}やめる"),
};
