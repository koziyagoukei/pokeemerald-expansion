...
static const struct MatchCallStructNPC sMrStoneMatchCallHeader =
{
    ...
    .flag = 0xFFFF,
    .desc = COMPOUND_STRING("{JPN}デボンしゃちょう"),
    .name = COMPOUND_STRING("{JPN}ツワブキ"),
...
static const struct MatchCallStructTrainer sNormanMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}つよくてたのもしい"),
    .name = COMPOUND_STRING("{JPN}パパ"),
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallBirch sProfBirchMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}ポケモンはかせ"),
    .name = COMPOUND_STRING("{JPN}オダマキ")
};
...
static const struct MatchCallStructNPC sMomMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}やさしくてきれい"),
    .name = COMPOUND_STRING("{JPN}ママ"),
    .textData = (const match_call_text_data_t[]) {
        { MatchCall_Text_Mom1, ALWAYS_AVAILABLE,            NO_FLAG_TO_SET },
        { MatchCall_Text_Mom2, FLAG_DEFEATED_PETALBURG_GYM, NO_FLAG_TO_SET },
        { MatchCall_Text_Mom3, FLAG_SYS_GAME_CLEAR,         NO_FLAG_TO_SET },
...
static const struct MatchCallStructNPC sStevenMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}いしがかたいひと"),
    .name = COMPOUND_STRING("{JPN}ダイゴ"),
    .textData = (const match_call_text_data_t[]) {
...
static const u8 gText_MayBrendanMatchCallDesc[] = _("{JPN}おとなりさん");
...
static const struct MatchCallWally sWallyMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}ポケモンがだいすき"),
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructNPC sScottMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}しんしゅつきぼつ"),
    .name = COMPOUND_STRING("{JPN}エニシダ"),
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sRoxanneMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}いわのゆうとうせい"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sBrawlyMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}ビッグなウェーブ"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sWattsonMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}でんげきおやじ"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sFlanneryMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}じょうねつのひと"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sWinonaMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}せかいのとりつかい"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sTateLizaMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}しんぴてきなコンビ"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sJuanMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}みわくのダンディ"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const u8 gText_EliteFourMatchCallDesc[] = _("{JPN}してんのう");
...
static const struct MatchCallStructTrainer sWallaceMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("{JPN}チャンピオン"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const u8 gText_MatchCallSteven_Strategy[] = _("{JPN}あいての じゃくてんを つく!");
static const u8 gText_MatchCallSteven_Pokemon[] = _("{JPN}さいきょうの はがねポケモン");

static const u8 gText_MatchCallBrendan_Strategy[] = _("{JPN}ポケモンの ちしきで しょうぶ");
static const u8 gText_MatchCallBrendan_Pokemon[] = _("{JPN}いろんな ポケモンを つかうぜ");
static const u8 gText_MatchCallBrendan_Intro1[] = _("{JPN}とうさんより すごい ポケモン");
static const u8 gText_MatchCallBrendan_Intro2[] = _("{JPN}はかせに なって みせるさ!");

static const u8 gText_MatchCallMay_Strategy[] = _("{JPN}しょうぶは とくいじゃないかも");
static const u8 gText_MatchCallMay_Pokemon[] = _("{JPN}どんな ポケモンでも つかうわ");
static const u8 gText_MatchCallMay_Intro1[] = _("{JPN}ポケモン つれて おとうさんの");
static const u8 gText_MatchCallMay_Intro2[] = _("{JPN}けんきゅうを おてつだい!");
...
static const struct MatchCallCheckPageOverride sCheckPageOverrides[] = {
    {
        ...
        .flavorTexts = {
            ...
            [CHECK_PAGE_INTRO_1]  = COMPOUND_STRING("{JPN}いしの ためなら"),
            [CHECK_PAGE_INTRO_2]  = COMPOUND_STRING("{JPN}たきだって のぼって いくよ")
        }
    },
    {
        .idx = MC_HEADER_STEVEN,
        ...
        .flavorTexts = {
            [CHECK_PAGE_STRATEGY] = gText_MatchCallSteven_Strategy,
            [CHECK_PAGE_POKEMON]  = gText_MatchCallSteven_Pokemon,
            [CHECK_PAGE_INTRO_1]  = COMPOUND_STRING("{JPN}けっきょく ボクが いちばん"),
            [CHECK_PAGE_INTRO_2]  = COMPOUND_STRING("{JPN}つよくて すごいんだよね")
        }
    },
    {
