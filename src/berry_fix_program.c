...
static const u8 sText_BerryProgramWillBeUpdatedPressA[] = _("The Berry Program on your POKEMON\n"
...
static const u8 sText_TurnOffPowerHoldingStartSelect[] = _("Please turn on the power of POKEMON\n"
