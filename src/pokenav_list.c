...
static const u8 gText_PokenavMatchCall_Strategy[] = _("{JPN}さくせん");
static const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("{JPN}もってる ポケモン");
static const u8 gText_PokenavMatchCall_SelfIntroduction[] = _("{JPN}じこしょうかい");
