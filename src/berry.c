...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_WIKI] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("to help Pokemon grip it."),
            .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
            .spicy = 0,
            .dry = 10,
            .sweet = 0,
    ...
    [BERRY_ID_TANGA] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("Bug Pokemon with its stringy petals."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 20,
            .dry = 0,
            .sweet = 0,
    ...
    [BERRY_ID_COLBUR] =
    {
        .info = {
            ...
            .description2 = COMPOUND_STRING("Pokemon to reach far？off places."),
            .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
            .spicy = 0,
            .dry = 0,
            .sweet = 0,
