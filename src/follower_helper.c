...
static const u8 sCondMsg07[] = _("Your POKEMON is staring intently at\nthe mountain peak.");
static const u8 sCondMsg08[] = _("Sniff sniff, something smells good!");
static const u8 sCondMsg09[] = _("Your POKEMON is surveying the\nshelves restlessly.");
...
static const u8 sCondMsg18[] = _("Waah! Your POKEMON suddenly splashed\nwater!");
static const u8 sCondMsg19[] = _("Your POKEMON is blowing sand in the\nair!");
static const u8 sCondMsg20[] = _("{STR_VAR_1} is playing around,\nplucking bits of grass.");
static const u8 sCondMsg21[] = _("Your POKEMON is happily looking at\nyour footprints!");
...
static const u8 sCondMsg25[] = _("Your POKEMON almost slipped and fell\nover!");
static const u8 sCondMsg26[] = _("Your POKEMON seems surprised to\ntouch ice.");
static const u8* const sColdTexts[] = {sCondMsg24, sCondMsg25, sCondMsg26, NULL};
static const u8 sCondMsg27[] = _("Your POKEMON has a flower petal on\nits face!");
...
static const u8 sCondMsg45[] = _("Your POKEMON is staring spellbound\nat the night sky!");
static const u8 sCondMsg46[] = _("Your POKEMON is happily gazing at\nthe beautiful, starry sky!");
